...
LIBFT_SRC_FILES = ft_atoi.c ft_bzero.c ft_calloc.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c ft_isspace.c ft_getchar.c\
				  ...
				  ft_putchar.c ft_putstr.c ft_putnbr.c ft_puthex.c ft_printf.c ft_putptr.c ft_putuint.c
